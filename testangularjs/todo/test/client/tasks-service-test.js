describe('task service tests', function () {
  ...
  it('delete should call service, register function', function (done) {
    httpBackend.expectDELETE('tasks/123412341234').respond(200, 'yup');
    var success = function (data) {
      expect(data).to.be.eql('yup');
      done();
    };
    service.delete('123412341234', success, notCalled);
    httpBackend.flush();
  });
  it('delete should call service, register error function', function (done) {
    httpBackend.expectDELETE('tasks/123412341234').respond(500, 'server error');
    ...
    service.delete('123412341234', notCalled, error);
    httpBackend.flush();
  });
});